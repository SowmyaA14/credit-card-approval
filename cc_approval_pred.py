...
def make_prediction():
    ...
    client = boto3.client('s3', aws_access_key_id=st.secrets["AKIAZQ3DQXB3FBREZT6J"],aws_secret_access_key=st.secrets["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"]) # for s3 API keys when deployed on streamlit share
